          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-600">
                <li>
                  <Link href="/villes/blois" className="hover:text-custom-blue transition-colors">
                    Blois - Château royal
                  </Link>
                </li>
                <li>
                  <Link href="/villes/chambord" className="hover:text-custom-blue transition-colors">
                    Chambord - Château majestueux
                  </Link>
                </li>
                <li>
                  <Link href="/villes/chenonceaux" className="hover:text-custom-blue transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-600">
                <li>
                  <Link href="/villes/cheverny" className="hover:text-custom-blue transition-colors">
                    Cheverny - Château de Tintin
                  </Link>
                </li>
                <li>
                  <Link href="/villes/romorantin" className="hover:text-custom-blue transition-colors">
                    Romorantin - Ville historique
                  </Link>
                </li>
                <li>
                  <Link href="/villes/soingsensologne" className="hover:text-custom-blue transition-colors">
